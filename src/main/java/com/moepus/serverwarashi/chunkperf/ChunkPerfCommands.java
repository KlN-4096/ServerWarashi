        ...
        root.then(net.minecraft.commands.Commands.literal("perf")
                .then(net.minecraft.commands.Commands.literal("list")
                        .then(net.minecraft.commands.Commands.literal("running")
                                .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.ACTIVE_ONLY, "Running ticket groups:", ChunkPerfSnapshot.SortMode.BLOCK_ENTITY))
                                .then(net.minecraft.commands.Commands.literal("entity")
                                        .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.ACTIVE_ONLY, "Running ticket groups:", ChunkPerfSnapshot.SortMode.ENTITY)))
                                .then(net.minecraft.commands.Commands.literal("blockentity")
                                        .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.ACTIVE_ONLY, "Running ticket groups:", ChunkPerfSnapshot.SortMode.BLOCK_ENTITY)))
                        )
                        .then(net.minecraft.commands.Commands.literal("lowered")
                                .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.PAUSED_ONLY, "Paused ticket groups:", ChunkPerfSnapshot.SortMode.BLOCK_ENTITY))
                                .then(net.minecraft.commands.Commands.literal("entity")
                                        .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.PAUSED_ONLY, "Paused ticket groups:", ChunkPerfSnapshot.SortMode.ENTITY)))
                                .then(net.minecraft.commands.Commands.literal("blockentity")
                                        .executes(context -> listGroups(context, ChunkPerfSnapshot.PauseMode.PAUSED_ONLY, "Paused ticket groups:", ChunkPerfSnapshot.SortMode.BLOCK_ENTITY)))
                        )
                )
